...
async function openResourceTab(title, resource){
    ...
    try{
        ...
        videoLink.href="#"; videoLink.textContent="▶ Click to play video"; videoLink.style.display="block"; videoLink.style.marginBottom="10px"; videoLink.style.fontWeight="bold";
